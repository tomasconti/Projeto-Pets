            ...
            <div class="cabecalho">
                ...
                <div class = "menu">
                    <ul>
                        ...
                        <li><a href = "altera_pet.html" >Alterar</a></li>
...
include "conexao.php";
 ...
 $sql="select * from pet  where excluido != 'S' order by nome";
...
if ($qtde > 0) {
     ...
     ?>
                ...
                <td><?php echo "<a href='altera_pet_confirma.php?cod_pet=$linha[cod_pet]'>Alterar</a>"; ?></td>
                    </tr>
                    <?php } ?>
                    </table>
                <?php 
